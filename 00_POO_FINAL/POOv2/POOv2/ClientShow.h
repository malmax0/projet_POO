...
namespace POOv2 {
	...
	/// <summary>
	/// Description résumée de ClientShow
	/// </summary>
	public ref class ClientShow : public Show
	{
	public:
		ClientShow(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button_Data->Click += gcnew System::EventHandler(this, &ClientShow::bt_button_Data_Click);
			// 
			// ClientShow
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1027, 644);
			this->Controls->Add(this->button_Data);
			this->Controls->Add(this->dataGridView1);
			this->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->Name = L"ClientShow";
			this->Text = L"ClientShow";
