...
public:
    ...
    void setupUi(QWidget *clientajoutClass)
    {
        ...
        clientajoutClass->resize(242, 226);
        ...
        BtClientAjout->setGeometry(QRect(39, 185, 131, 31));
        checkBox = new QCheckBox(clientajoutClass);
        checkBox->setObjectName(QString::fromUtf8("checkBox"));
        checkBox->setGeometry(QRect(19, 145, 191, 17));
    ...
    void retranslateUi(QWidget *clientajoutClass)
    {
        ...
        checkBox->setText(QCoreApplication::translate("clientajoutClass", "Voulez vous ajoutez une adresse ?", nullptr));
